            ...
            {!user ? (
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center justify-center w-10 h-10 rounded-full bg-blue-700 text-white font-semibold uppercase transition-all duration-200 hover:bg-black-300"
                >
                  {initials}
                </button>
                  ...
                  <div className="absolute right-0 mt-2 w-56 bg-white border border-gray-200 rounded-lg shadow-lg z-50 py-2">
                    {user?.role === 'Customer' ? (
                      <>
                        ...
                        <Link href="/addresses" className="block px-4 py-2 text-gray-700 hover:bg-gray-100 transition-colors">
                          Adreslerim
                        </Link>
                        <Link href="/payments" className="block px-4 py-2 text-gray-700 hover:bg-gray-100 transition-colors">
                          Ödeme Yöntemlerim
                        </Link>
                        <Link href="/account" className="block px-4 py-2 text-gray-700 hover:bg-gray-100 transition-colors">
                          Ayarlarım
                        </Link>
                        <button
                          onClick={logout}
                      ...
                      <>
                        <Link href="/supplier/panel" className="block px-4 py-2 text-gray-700 hover:bg-gray-100 transition-colors">
                          Tedarikçi Paneli
                        </Link>
                        <Link href="/account" className="block px-4 py-2 text-gray-700 hover:bg-gray-100 transition-colors">
                          Ayarlarım
            ...
            >
              <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-1.1 5.5A2 2 0 007.9 21h8.2a2 2 0 002-2.1L17 13H7m0 0h10m-5 4a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0z"
                />
              </svg>
