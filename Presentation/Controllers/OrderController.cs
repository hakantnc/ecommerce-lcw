...
namespace Presentation.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        public OrderController(IOrderService manager, ILogger logger)
        {
            _manager = manager;
            _logger = logger;
        }
        ...
        {
            _logger.LogInformation("Fetched all orders successfully.");
        ...
        {
            _logger.LogInformation($"Fetched order with ID {order_id} successfully.");
        ...
        public IActionResult CreateOneOrder([FromBody] Order order)
        {
            ...
            _logger.LogInformation($"Created order with ID {createdOrder.Id} successfully.");
        ...
        public IActionResult UpdateOneOrder(int order_id, [FromBody] OrderDtoForUpdate orderDto)
        {
            ...
            _logger.LogInformation($"Updating order with ID: {order_id}");
            return NoContent();
        }
        ...
        public IActionResult DeleteOneOrder(int order_id)
        {
            ...
            _logger.LogInformation($"Deleting order with ID: {order_id}");
            return NoContent();
        }
    }
}
